...
const OneWord = ({quizName}) => {
    ...
    async function handleSubmit (e){
        ...
        <h1 className="className='text-2xl font-bold mb-4 ml-6"> Create One Word Question</h1>
        ...
        <form>
            ...
            <button className="btnBack rounded-full py-2 px-10 hover:bg-red-dark -mb-20" onClick={() => navigate('/TeacherPage')}>
        Back
      </button>
